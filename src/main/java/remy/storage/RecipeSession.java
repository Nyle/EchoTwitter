...
public final class RecipeSession {
    ...
    /**
     * Creates a new instance of {@link RecipeSession} with the provided {@link Session} and
     * {@link RecipeSessionData}.
     * <p>
     ...
     */
    public static RecipeSession newInstance(Session session, RecipeSessionData seshData) {
     ...
     * Changes the step
     * 
     * @param i the int to which the Step is changed
     */
     ...
     * Changes the name
     * 
     * @param str is the new name
     */
    public void setName(String str) {
    	seshData.setName(str);
    }
