...
/**
 * The {@link ResponseManager} receives various events and intents and manages the flow of the
 * game.
 */
public class ResponseManager {
    ...
    public SpeechletResponse getLaunchResponse(LaunchRequest request, Session session) {
        ...
        return getAskSpeechletResponse("Ask me for a recipe.", "How about a souffle?");
    }
